package databaseConnect.api.pool;
...
public class DatabaseConnectionPool extends RMT2Base {
	...
	public static final Logger logger = LogManager.getLogger(DatabaseConnectionPool.class);
    ...
    public synchronized static DatabaseConnectionBean getAvailConnectionBean()
        ...
        DatabaseConnectionBean conBean = (DatabaseConnectionBean) DatabaseConnectionPool.DBAPI
                .getConnection();
        if (conBean == null) {
            logger.error("xzcxzzxc");
            throw new SystemException("xcvxcvxc");
        }
    ...
    public synchronized static DatabaseConnectionBean getAvailConnectionBean(
        ...
        DatabaseConnectionBean conBean = (DatabaseConnectionBean) DatabaseConnectionPool.DBAPI
                .getConnection();
        if (conBean == null) {
            throw new SystemException("xcvxcv");
