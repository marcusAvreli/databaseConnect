...
public class DbSqlConst {
    ...
    public static final Hashtable<Integer, String> SELECTOBJECT = new Hashtable<Integer, String>();
    static {
    ...
    public static final int getSelectObjectKey(String value) {
        ...
        for (int ndx = SELECT_KEY; ndx <= ORDERBY_KEY; ndx++) {
            ...
            if (value.equalsIgnoreCase("GROUPBY")
                    && clause.equals(GROUPBY_VALUE)) {
                return ndx;
            }
            if (value.equalsIgnoreCase("ORDERBY")
                    && clause.equals(ORDERBY_VALUE)) {
                return ndx;
            }
        }
    ...
    public static final Hashtable<Integer, String> DOCTYPES = new Hashtable<Integer, String>();
    static {
    ...
    public static final Hashtable<Integer, String> DATASOURCE_TYPES = new Hashtable<Integer, String>();
    static {
    ...
    public static final Hashtable<Integer, String> DBMS_VENDORS = new Hashtable<Integer, String>();
    static {
        DBMS_VENDORS.put(new Integer(DBMS_SYBASE_ASA_KEY),
                DBMS_SYBASE_ASA_VALUE);
        DBMS_VENDORS.put(new Integer(DBMS_SYBASE_ASE_KEY),
                DBMS_SYBASE_ASE_VALUE);
